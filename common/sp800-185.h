...
void cshake128(uint8_t *output, uint32_t outlen, const uint8_t *name, uint32_t namelen, const uint8_t *cstm, uint32_t cstmlen, const uint8_t *input, uint32_t inlen);
...
void cshake256(uint8_t *output, uint32_t outlen, const uint8_t *name, uint32_t namelen, const uint8_t* cstm, uint32_t cstmlen, const uint8_t *input, uint32_t inlen);
